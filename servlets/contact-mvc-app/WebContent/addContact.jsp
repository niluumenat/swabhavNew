...
First Name: <input type="text" name="firstname" value="<%=setFirstName %>"><br>
Last Name: <input type="text" name="lastname" value="<%=setLastName %>"><br>
Phone Number: <input type="text" name="phoneno" value="<%=setPhoneNo %>"><br>
Email Id: <input type="text" name="emailid" value="<%=setEmailId %>"><br>
